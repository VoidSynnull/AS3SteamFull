package game.particles.emitter.specialAbility
{
	...
	public class PsychadelicGum extends Emitter2D
	{
		public function init():void
		{
			super.counter = new Blast( 4 );
			
			addInitializer( new ChooseInitializer([new ExternalImage("assets/specialAbility/objects/gum/psychedelicFlower.swf"), 
				new ExternalImage("assets/specialAbility/objects/gum/psychedelicPeace.swf"),
				new ExternalImage("assets/specialAbility/objects/gum/psychedelicRainbow.swf"),
				new ExternalImage("assets/specialAbility/objects/gum/psychedelicSmile.swf")]));
