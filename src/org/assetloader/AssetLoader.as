package org.assetloader
{
	...
	public class AssetLoader extends AssetLoaderBase implements IAssetLoader
	{
		...
		public function AssetLoader(platform:IPlatform, id : String = "PrimaryGroup")
		{
			super(platform,id);
		}
		...
		override public function start() : void
		{
			...
			// RLH: if no loaders then complete now (when trying to load cached assets)
			if (_numLoaders == 0)
				super.complete_handler(null, _assets);
		}
