package game.scenes.ghd.neonWiener
{
	...
	public class Comics2 extends Popup
	{
		...
		{
			super.loadFiles([ "comics2.swf" ], false, true, loaded );
		}
		
		override public function loaded():void
		{
			super.screen = super.getAsset( "comics2.swf", true ) as MovieClip;
