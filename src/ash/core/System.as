package ash.core
{
	...
	public class System
	{
		 ...
		 */
		public function addToEngine( systemManager : Engine ) : void
		{
		 ...
		 */
		public function removeFromEngine( systemManager : Engine ) : void
		{
		...
		public var systemManager:Engine;
		public var _defaultPriority : int = 0;
		/**
		 * If this value is set it will cause the system to use fixed timesteps so that time is always equal to this value.  If fixed time systems
		 * fall behind they will be update multiple times in a frame to catch up.  If updates happen more frequently that a fixed-time system requires
		 * it will be skipped in the main update loop in the systemManager (ash.Engine).
		 */
		public var fixedTimestep:Number;
		public var linkedUpdate:String;
		public var onlyApplyLastUpdateOnCatchup:Boolean = false;
	}
}
