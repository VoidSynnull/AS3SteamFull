package com.poptropica.shellSteps.shared
{
	...
	/**
	 * Creates GameData, Managers, & DevTools 
	 * @author umckiba
	 * 
	 */
	public class CreateGame extends ShellStep
	{
		protected const MAX_FRAME_TIME:Number = 1;
		...
		/**
		 * Setup dev tools, allows for console commands and log output
		 */
		protected function createDevTools():void
		{
			var devTools:DevTools = new DevTools(shellApi.screenManager.devToolsContainer);
			shellApi.devTools = devTools;
			shellApi.injector.injectInto(devTools);
			devTools.init();
		}
	}
}