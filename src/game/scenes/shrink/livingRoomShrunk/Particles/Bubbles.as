package game.scenes.shrink.livingRoomShrunk.Particles
{
	...
	{
		public function init(emitLocation:Rectangle, emitVelocity:Point, scaleRange:Point,rate:Number = 10,lifetime:Number = .5, bubbleSize:Number = 2, outlineWidth:Number = 1, acceleration:Number = -50):void
		{
			counter = new Steady(rate);
			
			addInitializer( new BitmapImage(BitmapUtils.createBitmapData(new  Ring(bubbleSize, bubbleSize + outlineWidth)), true ) );
