package game.scenes.poptropolis.promoDive.particles
{
	...
	public class SandStream extends Emitter2D
	{	
		public function SandStream() {
			
		}
		
		public function init():void
		{
			counter = new Random(1, 5);
			
			//addInitializer( new ImageClass( DiveSand, [], true ) );
			addInitializer( new ChooseInitializer([new ExternalImage("assets/scenes/poptropolis/promoDive/sand1.swf"), 
				new ExternalImage("assets/scenes/poptropolis/promoDive/sand2.swf"),
				new ExternalImage("assets/scenes/poptropolis/promoDive/sand3.swf")]));
