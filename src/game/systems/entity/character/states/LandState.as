package game.systems.entity.character.states 
{
	 ...
	 */
	public class LandState extends CharacterState 
	{
		...
		private function updateAnimEnd( node:CharacterStateNode ):void
		{
		...
		private function updateSpin( node:CharacterStateNode ):void
		{
