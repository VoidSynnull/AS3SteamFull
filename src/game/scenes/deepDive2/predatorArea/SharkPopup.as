package game.scenes.deepDive2.predatorArea {
	...
	public class SharkPopup extends Popup {
		...
		override public function init(container:DisplayObjectContainer = null):void
		{
			...
			this.autoOpen 			= true;
			this.groupPrefix = "scenes/deepDive2/predatorArea/";
			this.screenAsset = "predatorPopup.swf";
		...
		{
			super.loaded();
			ButtonCreator.createButtonEntity(this.screen.content.tryAgainButton, this, onConfirmClicked, null, null, null, true, true, 2);
		...
		{
			shellApi.triggerEvent( "triggerFadeOut" );
			remove();
		}
	}
}