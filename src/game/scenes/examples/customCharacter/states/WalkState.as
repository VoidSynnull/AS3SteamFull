package game.scenes.examples.customCharacter.states
{
	...
	public class WalkState extends CustomCharacterState
	{
		...
		{
			return Math.abs(node.motion.velocity.x) >= node.characterMotionControl.walkSpeed;
		}
		...
		override public function update( time:Number ):void
		{
			...
			if( Math.abs(node.motion.velocity.x) < node.characterMotionControl.walkSpeed )	// check stand
			{
