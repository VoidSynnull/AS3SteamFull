package game.scenes.arab3.princessRoom
{
	...
	public class DiaryPopup extends Popup
	{
		public function DiaryPopup(container:DisplayObjectContainer=null)
		{
			super(container);
			
			this.id 				= "DiaryPopup";
			this.groupPrefix 		= "scenes/arab3/princessRoom/";
			this.screenAsset 		= "diaryPopup.swf";
