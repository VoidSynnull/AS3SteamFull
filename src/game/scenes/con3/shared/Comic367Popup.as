package game.scenes.con3.shared
{
	...
	public class Comic367Popup extends Popup
	{
		public function Comic367Popup(container:DisplayObjectContainer=null)
		{
			super(container);
		}
		...
		override public function loaded():void
		{
			...
			this.letterbox(screen.content, new Rectangle(0, 0, 757, 617), false);
