package game.particles.emitter.specialAbility 
{
	...
	public class ExternalAssetEmitter extends Emitter2D
	{
		
		private var sAssetPath : String = "";
		
		public function ExternalAssetEmitter(sPath:String) 
		{
			sAssetPath = sPath;
		}
		...
		private function swfReady(e:Event):void
		{
			...
			//addInitializer( new ImageClass( MusicNote, [5], true ) );
			addInitializer( new SharedImage( displayMC ) );
