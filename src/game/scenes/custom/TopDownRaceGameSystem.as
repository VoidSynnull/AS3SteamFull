package game.scenes.custom
{
	...
	public class TopDownRaceGameSystem extends GameSystem
	{
		private var _game:TopDownRaceGame;			// reference to top down race game
		...
		public function TopDownRaceGameSystem(game:TopDownRaceGame):void
		{
			...
			if (_moving)
			{
				...
				for (var i:int = _onScreenObstacles.length - 1; i!= -1; i--)
				{
					...
					if (y > _game.tileHeight * 1.25)
					{
						...
						// stop any animation
						entity.get(Display).displayObject.gotoAndStop(1);
					...
					if (!collider.isHit)
					{
						...
						switch(collider.type)
						{
							...
							case RaceCollider.BOOST:
								...
								// show boost clip, if any
								if (_game.boostClip != null)
								{
									_game.boostClip.visible = true;
									_game.boostClip.gotoAndPlay(1);
								}
							...
							case RaceCollider.SLICK:
								...
								// spin player
								_game.crashAnim(_game.playerEntity, true);
