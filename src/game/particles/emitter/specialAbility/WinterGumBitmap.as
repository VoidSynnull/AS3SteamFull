package game.particles.emitter.specialAbility 
{
	...
	public class WinterGumBitmap extends Emitter2D
	{	
		public function WinterGumBitmap()
		{
			_shouldBitmap = false;
		}
		public function init():void
		{
			super.counter = new Blast( 8 );
			...
			if(_shouldBitmap)
			{
				...
				addInitializer( new ExternalImage( "assets/particles/wintergum.swf", true) );
			
			addInitializer( new Lifetime( .5, 1 ) );;
			addInitializer( new Velocity( new DiscSectorZone( new Point( 0, 0 ), 120, Math.random()*120 - 60, -Math.PI, 0 ) ) );
