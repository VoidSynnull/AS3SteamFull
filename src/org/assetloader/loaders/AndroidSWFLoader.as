package org.assetloader.loaders
{
	 ...
	 */
	public class AndroidSWFLoader extends DisplayObjectLoader
	{
		/**
		 * @private
		 */
		...
		public function AndroidSWFLoader(request : URLRequest, id : String = null)
		{
			...
			{
				trace(request.url + "probably isn't on the device")
			}
			else
			{
				...
				{
					trace( "ERROR :: AndroidSWFLoader :: failed to open file: " + request.url + " ErrorID: " + error.errorID);
				}
				inFileStream.close();
				inFileStream = null;
			}
