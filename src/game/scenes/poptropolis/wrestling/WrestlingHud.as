package game.scenes.poptropolis.wrestling
{
	...
	public class WrestlingHud extends UIView
	{
		...
		public function WrestlingHud(container:DisplayObjectContainer=null)
		{
			super(container);
			super.id = "gameHud";
		}
		...
		override public function load():void
		{
			...
			super.loadFiles(new Array("practiceHud.swf"));
		}
		...
		{			
			...
			super.screen = super.getAsset("practiceHud.swf", true) as MovieClip;
