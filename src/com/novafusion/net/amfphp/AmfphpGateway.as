...
{
    import de.polygonal2.ds.Iterator;
    import de.polygonal2.ds.HashMap;
    ...
    public class AmfphpGateway extends NetConnection
    {
        ...
        public function addCall(...params):Call
        {
			...
			// if the first parameter is an already made call object
            if (params[0] is Call)
            {
                callObj = params[0];
            ...
            {
				// if a string is the first parameter (meaning a service string)
